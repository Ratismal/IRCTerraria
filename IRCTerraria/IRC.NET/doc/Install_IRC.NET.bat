...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Alex Regueiro" /mediaBookList "IRC.NET Documentatoin" /productName "IRC.NET" > NUL
...
COPY /Y "IRC.NET.msha" HelpContentSetup.msha
